...
const BreathingTool: React.FC = () => {
    ...
    const ModalBody = () => {
            ...
            return ( // InhalePanel's rerendering bc of setProgress iteration is messing w animate-bounce for "Deep Breaths" & "Inhale" by constantly re-rendering, must decouple
                <div className='flex flex-col items-center gap-16'>
                    ...
                    <div className={`radial-progress ${radialColor} font-semibold text-2xl text-white`}
                        style={{ "--value": progress, "--size": "18rem", "--thickness": "0.6rem" } as any} role="progressbar">
        ...
        const closeModal = () => {
            ...
            // setProgress(0); setCycle(false); setCountdown(8);
            // setCycleCount(0)
            setModalOpen(false)
        }
        return (
    ...
    return (
        <div className='flex w-[25vw]'>
            <button className="flex-grow bg-emerald-400 hover:bg-emerald-500 text-slate-100 font-bold py-1 mt-1 rounded-3xl w-4/12"
