            ...
            <div className="flex-1 flex-col font-medium rounded-s shadow-md my-2 bg-slate-0">
                ...
                <div className="flex flex-row text-teal-500 tracking-tight py-3"> 
                    <div className='flex flex-row font-normal text-5xl gap-3'>😄
                        ...
                        <div className='flex flex-col justify-start font-normal text-2xl'>
                            GOOD
                            <div className='flex flex-row font-normal text-sm gap-2'> 
                                <FaDumbbell className='mt-1'/>  <span className='text-slate-400'>exercise</span>
                            </div>    
                            <div className='flex text-sm text-slate-500 mt-4 gap-1'> <span className='font-semibold'>Note: </span>Today I slept in and exercised. </div>
                        </div>
                        
                        <div className='font-normal text-slate-400 text-sm mt-2'> 10:28 AM</div>        
                    </div>
                </div>
            </div>
        );
